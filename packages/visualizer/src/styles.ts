...
export const regionStyles: CSSResultGroup = css`
  .region {
    border: 1px dashed var(--viz-region-border, #e0e0e0);
    border-radius: 12px;
    background: var(--viz-region-bg, rgba(0, 0, 0, 0.02));
    padding: 16px;
    position: relative;
  }
...
export const controlsStyles: CSSResultGroup = css`
  ...
  .controls button {
    width: 32px;
    height: 32px;
    border: 1px solid var(--viz-control-border);
    background: var(--viz-control-background);
    border-radius: 4px;
    cursor: pointer;
    font-size: 16px;
    display: flex;
  ...
  .controls button:hover {
    background: var(--viz-control-hover);
  }
...
export const zoomIndicatorStyles: CSSResultGroup = css`
  .zoom-indicator {
    position: absolute;
    bottom: 12px;
    left: 50%;
...
export const minimapStyles: CSSResultGroup = css`
  .minimap {
    position: absolute;
    bottom: 12px;
    left: 12px;
  ...
  .minimap-viewport {
    border: 1px solid var(--viz-node-selected-border);
  ...
  .minimap-node {
    position: absolute;
    background: var(--viz-node-border);
    border-radius: 2px;
  }

  .minimap-node.active {
    background: var(--viz-node-active-border);
  }
`;

...
- [x] **Edge labels for transitions** — Current edge labels show event IDs but not guard conditions or actions
- [x] **Keyboard shortcuts documentation** — +/-/0/F shortcuts work but no tooltip or help overlay
